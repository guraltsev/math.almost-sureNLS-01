...
\runtitle{Almost sure local well-posedness for cubic NLS}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author[A]{\inits{J-B.}\fnms{Jean-Baptiste}~\snm{Casteras}\ead[label=e1]{jeanbaptiste.casteras@gmail.com}},
\author[B]{\inits{J.}\fnms{Juraj}~\snm{Juraj F\" oldes}\ead[label=e2]{foldes@virginia.edu}}
\and
\author[B]{\inits{G.}\fnms{Gennady}~\snm{Uraltsev}\ead[label=e3]{gennady.uraltsev@gmail.com}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Addresses                                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\address[A]{CMAFcIO, Faculdade de Ci\^encias da Universidade de Lisboa, Edificio C6, Piso 1, Campo Grande 1749-016 Lisboa, Portugal\printead[presep={,\ }]{e1}}

\address[B]{Dept. of Mathematics, University of Virginia, Kerchof Hall, Charlottesville, VA 22904-4137\printead[presep={,\ }]{e2,e3}}
\end{aug}
...
Dans ce papier, nous montrons que l'équation cubique de Schrödinger 
$$ (i\partial_t - P) u = \pm |u|^2 u\quad \textrm{ sur }\ I\times \R^d ,$$
est localement bien posée pour des données initiales aléatoires, et où $P$ est un opérateur d'ordre $s\geq 2$. En utilisant des estimations fines dans des espaces anisotropiques, nous améliorons et étendons les résultats connus pour l'équation de Schrödinger classique (c'est à dire lorsque $P$ est le Laplacien) à toutes les dimensions sous des hypothèses satisfaisantes sur $P$, dont le symbole de Fourier peut changer de signe. De façon intéressante, nous mettons en évidence l'existence d'un nouveau régime dépendant de $s$ et $d$ qui n'était pas présent pour le Laplacien.
\end{abstract}
...
\begin{keyword}
\kwd{Schr\"odinger equation}
\kwd{almost-sure local well-posedness}
\kwd{random initial data}
\end{keyword}
